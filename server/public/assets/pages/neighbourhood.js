...
$(document).on('click','#searchterm', function(){
    ...
    if(term == ""){
        window.location.href="/neighbourhood";
    } else {
        window.location.href="/neighbourhood?search="+term;
    }
});
